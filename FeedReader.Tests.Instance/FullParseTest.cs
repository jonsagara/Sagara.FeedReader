...
public class FullParseTest
{
    ...
    {
        var feed = (AtomFeed)(await _feedReaderSvc.ReadFromFileAsync("Feeds/AtomAdobe.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (AtomFeed)(await _feedReaderSvc.ReadFromFileAsync("Feeds/AtomTheVerge.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (AtomFeed)(await _feedReaderSvc.ReadFromFileAsync("Feeds/AtomYoutubeInvestmentPunk.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (Rss091Feed)(await _feedReaderSvc.ReadFromFileAsync("Feeds/Rss091Stadtfeuerwehr.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (Rss091Feed)(await _feedReaderSvc.ReadFromFileAsync("Feeds/Rss091FullSample.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (Rss092Feed)(await _feedReaderSvc.ReadFromFileAsync("Feeds/Rss092FullSample.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (Rss10Feed)(await _feedReaderSvc.ReadFromFileAsync("Feeds/Rss10FeedWebResourceSample.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (Rss10Feed)(await _feedReaderSvc.ReadFromFileAsync("Feeds/Rss10OrfAt.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (Rss20Feed)(await _feedReaderSvc.ReadFromFileAsync("Feeds/Rss20FeedWebResourceSample.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (Rss20Feed)(await _feedReaderSvc.ReadFromFileAsync("Feeds/Rss20CodeHollowCom.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (Rss20Feed)(await _feedReaderSvc.ReadFromFileAsync("Feeds/Rss20ContentWindCom.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (Rss20Feed)(await _feedReaderSvc.ReadFromFileAsync("Feeds/Rss20MoscowTimes.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (Rss20Feed)(await _feedReaderSvc.ReadFromFileAsync("Feeds/Rss20ISO88591Intranet30.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = await _feedReaderSvc.ReadFromFileAsync("Feeds/Rss20CityDog.xml").ConfigureAwait(false);
    ...
    public async Task TestAllFilesForException_Async()
    {
        ...
        {
            var feed = await _feedReaderSvc.ReadFromFileAsync(file).ConfigureAwait(false);
            if (feed is not null)
            {
