...
This is a heavily-modified, forked version of the official repository. Please refer to the original repo, upon which the `CodeHollow.FeedReader` nuget package is based:
