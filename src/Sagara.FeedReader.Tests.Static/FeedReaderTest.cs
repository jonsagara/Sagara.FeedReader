...
public class FeedReaderTest
{
    ...
    public async Task TestAcceptHeaderForbiddenWithParsing()
    {
        ...
        var feed = await FeedReader.ReadAsync("http://www.girlsguidetopm.com/feed/");
    ...
    public async Task TestParseAndAbsoluteUrlDerStandard1()
    {
        ...
        var links = await FeedReader.GetFeedUrlsFromPageAsync(url);
    ...
    {
        var feed = await FeedReader.ReadAsync("https://blog.adobe.com/feed.xml");
        string? title = feed.Title;
    ...
    {
        var feed = await FeedReader.ReadAsync("charter97.org/rss.php");
        Assert.True(!string.IsNullOrEmpty(feed.Title));
    }
    ...
    {
        var feed = await FeedReader.ReadAsync("https://www.techrepublic.com/rssfeeds/topic/project-management/");
    ...
    //{
    //    var feed = await FeedReader.ReadAsync("http://us10.campaign-archive.com/feed?u=8da2e137a07b178e5d9a71c2c&id=9134b0cc95");
