...
public class FullParseTest
{
    ...
    {
        var feed = (AtomFeed)(await FeedReaderService.ReadFromFileAsync("Feeds/AtomAdobe.xml")).SpecificFeed!;
    ...
    {
        var feed = (AtomFeed)(await FeedReaderService.ReadFromFileAsync("Feeds/AtomTheVerge.xml")).SpecificFeed!;
    ...
    {
        var feed = (AtomFeed)(await FeedReaderService.ReadFromFileAsync("Feeds/AtomYoutubeInvestmentPunk.xml")).SpecificFeed!;
    ...
    {
        var feed = (Rss091Feed)(await FeedReaderService.ReadFromFileAsync("Feeds/Rss091Stadtfeuerwehr.xml")).SpecificFeed!;
    ...
    {
        var feed = (Rss091Feed)(await FeedReaderService.ReadFromFileAsync("Feeds/Rss091FullSample.xml")).SpecificFeed!;
    ...
    {
        var feed = (Rss092Feed)(await FeedReaderService.ReadFromFileAsync("Feeds/Rss092FullSample.xml")).SpecificFeed!;
    ...
    {
        var feed = (Rss10Feed)(await FeedReaderService.ReadFromFileAsync("Feeds/Rss10FeedWebResourceSample.xml")).SpecificFeed!;
    ...
    {
        var feed = (Rss10Feed)(await FeedReaderService.ReadFromFileAsync("Feeds/Rss10OrfAt.xml")).SpecificFeed!;
    ...
    {
        var feed = (Rss20Feed)(await FeedReaderService.ReadFromFileAsync("Feeds/Rss20FeedWebResourceSample.xml")).SpecificFeed!;
    ...
    {
        var feed = (Rss20Feed)(await FeedReaderService.ReadFromFileAsync("Feeds/Rss20CodeHollowCom.xml")).SpecificFeed!;
    ...
    {
        var feed = (Rss20Feed)(await FeedReaderService.ReadFromFileAsync("Feeds/Rss20ContentWindCom.xml")).SpecificFeed!;
    ...
    {
        var feed = (Rss20Feed)(await FeedReaderService.ReadFromFileAsync("Feeds/Rss20MoscowTimes.xml")).SpecificFeed!;
    ...
    {
        var feed = (Rss20Feed)(await FeedReaderService.ReadFromFileAsync("Feeds/Rss20ISO88591Intranet30.xml")).SpecificFeed!;
    ...
    {
        var feed = await FeedReaderService.ReadFromFileAsync("Feeds/Rss20CityDog.xml");
    ...
    public async Task TestAllFilesForException_Async()
    {
        ...
        {
            var feed = await FeedReaderService.ReadFromFileAsync(file);
            if (feed is not null)
            {
