...
public class FullParseTest
{
    ...
    {
        var feed = (AtomFeed)(await FeedReaderService.ReadFromFileAsync("Feeds/AtomAdobe.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (AtomFeed)(await FeedReaderService.ReadFromFileAsync("Feeds/AtomTheVerge.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (AtomFeed)(await FeedReaderService.ReadFromFileAsync("Feeds/AtomYoutubeInvestmentPunk.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (Rss091Feed)(await FeedReaderService.ReadFromFileAsync("Feeds/Rss091Stadtfeuerwehr.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (Rss091Feed)(await FeedReaderService.ReadFromFileAsync("Feeds/Rss091FullSample.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (Rss092Feed)(await FeedReaderService.ReadFromFileAsync("Feeds/Rss092FullSample.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (Rss10Feed)(await FeedReaderService.ReadFromFileAsync("Feeds/Rss10FeedWebResourceSample.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (Rss10Feed)(await FeedReaderService.ReadFromFileAsync("Feeds/Rss10OrfAt.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (Rss20Feed)(await FeedReaderService.ReadFromFileAsync("Feeds/Rss20FeedWebResourceSample.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (Rss20Feed)(await FeedReaderService.ReadFromFileAsync("Feeds/Rss20CodeHollowCom.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (Rss20Feed)(await FeedReaderService.ReadFromFileAsync("Feeds/Rss20ContentWindCom.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (Rss20Feed)(await FeedReaderService.ReadFromFileAsync("Feeds/Rss20MoscowTimes.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = (Rss20Feed)(await FeedReaderService.ReadFromFileAsync("Feeds/Rss20ISO88591Intranet30.xml").ConfigureAwait(false)).SpecificFeed!;
    ...
    {
        var feed = await FeedReaderService.ReadFromFileAsync("Feeds/Rss20CityDog.xml").ConfigureAwait(false);
    ...
    public async Task TestAllFilesForException_Async()
    {
        ...
        {
            var feed = await FeedReaderService.ReadFromFileAsync(file).ConfigureAwait(false);
            if (feed is not null)
            {
